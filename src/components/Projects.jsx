...
const prevProject = ()=>{
  ...
  return (
    ...
    <div className='overflow-hidden'>
        <div className='flex gap-8 transition-transform duration-500 ease-in-out' style={{transform:`translate(-${(currentIndex * 100) / cardsToShow}%)`}}>
                ...
                <div key={index} className='relative flex-shrink-0 w-full sm:w-1/4'>
                    ...
                    <div className='absolute left-0 right-0 bottom-5 flex justify-center'>
                        <div className='inline-block bg-white w-3/4 px-4 py-2 shadow-md'>
                            ...
                            <p className='text-gray-600'>{project.price} <span className='px-1'>|</span>{project.location}</p>
                        </div>
                    </div>
                </div>
            ))}
